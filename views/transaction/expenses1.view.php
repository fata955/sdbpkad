                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="d-flex bd-highlight text-center mt-4">
                                ...
                                <div class="flex-fill bd-highlight">
                                    <small class="text-muted">Tagihan SPM</small>
                ...
                <div class="col-md-12">
                    <div class="d-flex">
                        ...
                        <div class="inbox left" id="email-nav">
                            <div class="mail-side">
                                <ul class="nav">
                                    <li class="active"><a href="/sdbpkad/expenses"><i
                                    ...
                                    <li><a href="/sdbpkad/sp2dver"><i class="zmdi zmdi-badge-check"></i>SP2D </a>
                                    </li>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="card">
                                                                        <div class="table-responsive">
                                                                            <table
                                                                                class="table table-bordered table-striped table-hover dataTable js-exportable"
                                                                                style="width: 600px;" id="tablespmver">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th data-breakpoints="xs">Verif
                                                                                        </th>
        ...
        <form method="POST" id="editForm">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="largeModalLabel">VERIFIKASI SPM</h4>
                </div>
              ...
              name="keterangan" disabled/> -->
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select name='idsumber' class="form-control ms">
                            ...
                            $sumberdana = mysqli_query($conn, "SELECT b.id,b.namasubsumberdana from subssumber b, t_salur a where a.jenis_dana=b.id AND a.status='AKTIF'");
...
<script>
    $(document).ready(function () {
        fetchData();
        fetchDataVer();
        let table = new DataTable("#tablespm");
        let table1 = new DataTable("#tablespmver");
        ...
        function fetchData() {
            $.ajax({
                url: "proses/transaction/executespm.php?action=fetchData",
                type: "POST",
                dataType: "json",
        ...
        $("#tablespm").on("click", ".editBtn", function () {
            ...
            var id = $(this).val();
            $.ajax({
                url: "proses/transaction/executespm.php?action=fetchSingle",
                type: "POST",
                dataType: "json",
                data: {
                    id: id
                ...
                success: function (response) {
                    var data = response.data;
                    var danaspm = data.nilai_spm;
                    $("#editForm #id").val(data.id);
                    $("#editForm input[name='nomorspm']").val(data.nomor_spm);
                    $("#editForm textarea[name='keterangan']").val(data.keterangan_spm);
                    $("#editForm input[name='opd']").val(data.nama_sub_skpd);
                    $("#editForm input[name='nilai_spm']").val(formatRupiah(danaspm, "Rp. "));
