                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <input
                            type="text"
                            class="form-control"
                            name="kontrol" id='kontrol' required />
                    </div>
                    <div class="input-group mb-3">
                        <input
                            type="text
                            class="form-control"
                            name="nsalur" id='nsalur' required />
                    </div>
                    <div class="input-group mb-3">
                        <input
                            type="hidden"
        ...
        $("#insertdata").on("submit", function(e) {
            ...
            then((result) => {
                if (result.isConfirmed) {
                    ...
                    if (kontrol == 1) {
                        $.ajax({
                            url: "proses/transaction/expenses.php?action=DataMasuk",
                            type: "POST",
                            ...
                            success: function(response) {
                                ...
                                if (response.statusCode == 200) {
                                    ...
                                    Swal.fire({
                                        ...
                                        text: "Refresh Kembali browser anda",
                                        position: "bottom",
                                        backdrop: "linear-gradient(pink, orange)",
                                        background: "white",
