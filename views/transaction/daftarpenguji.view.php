...
<script>
    $(document).ready(function() {
        ...
        function fetchspm() {
            $.ajax({
                url: "proses/transaction/penguji.php?action=fetchVerifikasi",
                type: "POST",
                dataType: "json",
        ...
        function fetchVerif() {
            $.ajax({
                url: "proses/transaction/penguji.php?action=fetchVerif",
                type: "POST",
                dataType: "json",
                success: function(response) {
        ...
        $("#filtertanggal").on("click", "#filter", function(e) {
            ...
            var opdlg = $('#opdlg').val();
            $.ajax({
                url: "proses/transaction/penguji.php?action=filtertanggal",
                type: "POST",
                dataType: "json",
                data: {
                    start: start,
        ...
        $("#filtertanggal").on("click", "#tglverif", function(e) {
            ...
            var opdlg = $('#opdlg').val();
            $.ajax({
                url: "proses/transaction/penguji.php?action=filtertglverif",
                type: "POST",
                dataType: "json",
                data: {
                    start: start,
        ...
        $("#myTablespm").on("click", ".editBtnspm   ", function() {
            ...
            var id = $(this).val();
            $.ajax({
                url: "proses/transaction/penguji.php?action=fetchSingle",
                type: "POST",
                dataType: "json",
                data: {
                    id: id
        ...
        $("#dana").on("change", function() {
            ...
            // kosong();
            $.ajax({
                url: "proses/transaction/penguji.php?action=fetchSalur",
                type: "POST",
                dataType: "json",
                data: {
                    idsalur: idsalur,
        ...
        $("#insertdata").on("submit", function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "proses/transaction/penguji.php?action=insertData",
                type: "POST",
        ...
        $("#dataall").on("click", function() {
            ...
            // var today = new date();
            window.location.href = '/sdbpkad/penguji';
        ...
        $("#filtertanggal").on("click", "#dataprint", function(e) {
            ...
            $.ajax({
                url: "proses/transaction/penguji.php?action=printData",
                type: "POST",
                dataType: "json",
                data: {
                    start: start,
        ...
        $("#nilaisumberdana").on("click", ".deleteBtnsubsumber", function() {
            if (confirm("Apakah yakin Menghapus Beranda Anda?")) {
                ...
                $.ajax({
                    url: "proses/transaction/penguji.php?action=deleteSB",
                    type: "POST",
                    dataType: "json",
                    data: {
                        id: id
        ...
        $("#nilaisumberdana").on("click", ".EditBtnsubsumber", function() {
            var id = $(this).val();
            $.ajax({
                url: "proses/transaction/penguji.php?action=Single",
                type: "POST",
                dataType: "json",
                data: {
                    id: id
